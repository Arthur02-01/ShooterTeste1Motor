...
public class Alinhador extends SubsystemBase {
    ...
    private final SparkMax BoquinhaMotor;
    ...
    public Alinhador() {
        ...
        BoquinhaMotor = new SparkMax(
            Constants.Alinhador.AlinhadorBoquinha,
            MotorType.kBrushless
        );

        Boquinhaencoder = BoquinhaMotor.getEncoder();
        pid = BoquinhaMotor.getClosedLoopController();
    ...
    public double getAngulo() {
        return Boquinhaencoder.getPosition() * (360.0 / REDUCAO);
    }

    public double getAnguloRad() {
        return Math.toRadians(getAngulo());
    }
    public double getAlinhadorBoquinhaPosition(){
...
private double aplicarZonaDesaceleracao(double velocidade) {
    ...
    public void controleManual(double velocidade) {
        ...
        BoquinhaMotor.set(velocidade + ffPercent);
    }
